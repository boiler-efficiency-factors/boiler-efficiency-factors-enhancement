import svgPaths from "./svg-ljulk6ezbe";
...
function Frame2() {
  return (
    <div className="absolute bg-[var(--darkreader-background-ffffff,#dcdad7)] content-stretch flex flex-col gap-[8px] items-center justify-center left-1/2 px-0 py-[40px] rounded-[24px] top-[calc(50%+16px)] translate-x-[-50%] translate-y-[-50%] w-[1000px]">
      <Frame3 />
      <Frame1 />
      <WithNumbers />
    </div>
...
export default function Home() {
  return (
    <div className="bg-[var(--darkreader-background-f9f9f9,#d8d6d2)] relative size-full" data-name="Home">
      <Frame2 />
      <NavBar />
